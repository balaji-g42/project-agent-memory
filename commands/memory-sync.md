---
description: Halt the current task and sync new decisions, progress, patterns and context changes to memory-qdrant-mcp.
---
...
2. Write each via the memory-qdrant-mcp tools:
